...
export const board = {
  ...
  primary: {
    pick: 'Nhận',
    andyComplete: 'VP duyệt → hoàn tất',
    andyBop: 'Trình BOP…',
    sendAccounting: 'Gửi Accounting…',
  ...
  toasts: {
    ...
    sentAccPaymentClosed: 'Đã gửi Accounting — hồ sơ Payment đã đóng.',
    sentAcc: 'Đã gửi Accounting.',
    skippedCompleted: 'Đã hoàn tất luôn — bỏ qua Accounting/BOP.',
    receivedFromAcc: 'Đã nhận về từ Accounting.',
  ...
  modals: {
    ...
    receiveAcc: {
      title: 'Nhận về từ Accounting',
      confirm: 'Đã nhận về từ Accounting',
      dateLabel: 'Ngày nhận từ Accounting',
    },
    batchAcc: {
    ...
    sendAccounting: {
      ...
      failError: 'Gửi Accounting thất bại — thử lại.',
      submit: 'Gửi Accounting',
